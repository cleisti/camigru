	...
	<body>
		<header>
			<nav class="navbar fixed-top navbar-expand-sm navbar-light bg-light" style="padding-left: 25vw;">
				<a class="navbar-brand" href="index.php?page=gallery/gallery"><img src="camigruLogo.png" style="width: 120px"></a>
			...
			<?php }	else { ?>
						<li class="nav-item">
							<a class="navbar-brand" href="index.php?page=gallery/upload">Create</a>
						</li>
						<li class="nav-item">
							<a class="navbar-brand" href="index.php?page=account/profile">Profile</a>
						</li>
						<li class="nav-item">
